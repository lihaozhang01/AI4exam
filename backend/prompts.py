...
EVALUATE_ESSAY_PROMPT = {
    "system_prompt": "你是一位经验丰富的阅卷老师。任务是根据参考答案，为一个学生对论述题的回答进行打分和评价。",
    "format_instructions": """
**原始题目:**
{question_stem}
...
请分析以上信息，以友好的语气，生成一段 markdown 格式的反馈。直接开始书写反馈内容，不要包含任何额外的标题或前言。
"""
}